...
local Window = Library:CreateWindow({
    Title = "<font color=\"#7FC8F0\">A</font><font color=\"#74C0EB\">F</font><font color=\"#69B8E6\">H</font><font color=\"#5EB0E1\">U</font><font color=\"#53A8DC\">B</font><font color=\"#48A0D7\">（</font><font color=\"#3D98D2\">重</font><font color=\"#3290CD\">置</font><font color=\"#2788C8\">版</font><font color=\"#1C80C3\">）</font>",
    Footer = "By 秋辞",
    Size = UDim2.fromOffset(750, 650),
    Icon = "rbxassetid://137477291147058",
    AutoShow = true,
    NotifySide = "Right",
...
local Afhubyyds = Tabs.Afhubyyds:AddRightGroupbox("悔脚本专区(和付费脚本差不多)", "medal")
Afhubyyds:AddButton({Text="悔脚本",Func=function()
        loadstring(game:HttpGet("https://api.luarmor.net/files/v4/loaders/f899366f7d9a60f6decf7fb9d8345b9e.lua"))()
        local Func = loadstring(ScriptContent);
        if Func then
                Func();
        end
...
Afhubyyds:AddLabel("支持服务器如下：")
Afhubyyds:AddLabel("草原生活(萨凡纳)-应该是国内最强")
Afhubyyds:AddLabel("钩中啦！(盗用老外)")
Afhubyyds:AddLabel("住宅大屠杀(第一夜)")
Afhubyyds:AddLabel("摊位世界不会做这个服务器所以挺垃圾的")
Afhubyyds:AddLabel("99夜")
Afhubyyds:AddLabel("手枪竟技")
Afhubyyds:AddLabel("沉默的剑客")

local Afhubyyds = Tabs.Afhubyyds:AddRightGroupbox("联邦免费脚本YI＿Hub", "flag")
