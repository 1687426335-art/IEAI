...
task.spawn(function()
    ...
    st.Color = Color3.fromRGB(0, 255, 170)
    st.Thickness = 2
    st.Transparency = 0.3
    ...
    tip.Position = UDim2.new(0, 0, 0, 60)
    ...
    local pcs = Instance.new("UIStroke", pcBtn)
    pcs.Color = Color3.fromRGB(150, 200, 255)
    pcs.Thickness = 2
    pcs.Transparency = 0.3
    ...
    local mbs = Instance.new("UIStroke", mobileBtn)
    mbs.Color = Color3.fromRGB(150, 255, 180)
    mbs.Thickness = 2
