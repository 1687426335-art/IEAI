...
function createUI()
    ...
    local function createDynamicIsland()
        ...
        container.Size = UDim2.new(0, 126, 0, 36)
        container.Position = UDim2.new(0.5, -63, 0, 12)
        ...
        local function breatheLoop()
            while gui and gui.Parent do
                -- 光晕1透明度呼吸
                local t1 = TweenService:Create(glow1, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
                    Transparency = 0.5
                })
                local t2 = TweenService:Create(glow1, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
                    Transparency = 0.85
                })
                -- 光晕2透明度呼吸
                local t3 = TweenService:Create(glow2, TweenInfo.new(2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
                    Transparency = 0.7
                })
                local t4 = TweenService:Create(glow2, TweenInfo.new(2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
                    Transparency = 0.92
                })
                -- 小圆点脉动
                local dot1 = TweenService:Create(dot, TweenInfo.new(0.8, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
                    Size = UDim2.new(0, 12, 0, 12),
                    Position = UDim2.new(0, 9, 0.5, -6)
                })
                local dot2 = TweenService:Create(dot, TweenInfo.new(0.8, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
        ...
        -- 从顶部滑入动画
        local startPos = UDim2.new(0.5, -63, 0, -40)
        local endPos = UDim2.new(0.5, -63, 0, 12)
