...
local function GetDeviceUID()
    ...
    -- 备用方案：使用UserId + 硬件信息组合
    return player.UserId .. "_" .. tostring(game:GetService("Workspace").DistributedGameTime)
end
...
local function CreateKeyUI(onSuccess)
    ...
    mainFrame.BorderColor3 = Color3.fromRGB(255, 150, 175)
    ...
    topBar.BackgroundColor3 = Color3.fromRGB(255, 150, 175)
    ...
    uidLabel.Size = UDim2.new(1, 0, 0, 20)
    uidLabel.Position = UDim2.new(0, 0, 0, 50)
    uidLabel.BackgroundTransparency = 1
    uidLabel.Text = "设备UID: " .. string.sub(DEVICE_UID, 1, 20) .. "..."
    uidLabel.TextColor3 = Color3.fromRGB(180, 180, 210)
    ...
    inputBg.Position = UDim2.new(0.075, 0, 0, 115)
    ...
    verifyBtn.Position = UDim2.new(0.325, 0, 0, 220)
    verifyBtn.BackgroundColor3 = Color3.fromRGB(255, 150, 175)
    verifyBtn.BackgroundTransparency = 0.15
    verifyBtn.BorderSizePixel = 2
    verifyBtn.BorderColor3 = Color3.fromRGB(255, 150, 175)
    verifyBtn.Text = "验证卡密"
    ...
    tip.Position = UDim2.new(0, 0, 0, 285)
    ...
    infoFrame.Position = UDim2.new(0.05, 0, 0, 320)
    infoFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 60)
    infoFrame.BackgroundTransparency = 0.3
    infoFrame.BorderSizePixel = 1
    infoFrame.BorderColor3 = Color3.fromRGB(60, 60, 90)
